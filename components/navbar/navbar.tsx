...
const Navbar = () => {
    ...
    return (
        ...
        <nav className="w-full fixed z-40">
            <div className={`px-4 md:px-16 py-6 flex flex-row items-center transition duration-500 bg-green-700 border-green-500 border-[1.5px] border-opacity-40 ${!ShowBackground ? 'bg-opacity-50' : ''}`}>
